...
#include <veins/modules/application/traci/HybridMethodRSUApp.h>
...
Define_Module(veins::HybridMethodRSUApp);

void HybridMethodRSUApp::initialize(int stage)
{
...
void HybridMethodRSUApp::onWSM(BaseFrame1609_4* frame)
{
...
void HybridMethodRSUApp::handleGateMsg(cMessage* msg)
{
