...
void DemoBaseApplLayerRSU::initialize(int stage)
{
...
simtime_t DemoBaseApplLayerRSU::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void DemoBaseApplLayerRSU::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
...
void DemoBaseApplLayerRSU::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details)
{
    Enter_Method_Silent();
...
void DemoBaseApplLayerRSU::handlePositionUpdate(cObject* obj)
{
...
void DemoBaseApplLayerRSU::handleParkingUpdate(cObject* obj)
{
    isParked = mobility->getParkingState();
}

void DemoBaseApplLayerRSU::handleLowerMsg(cMessage* msg)
{
...
void DemoBaseApplLayerRSU::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind()) {
...
void DemoBaseApplLayerRSU::finish()
{
...
DemoBaseApplLayerRSU::~DemoBaseApplLayerRSU()
{
...
void DemoBaseApplLayerRSU::startService(Channel channel, int serviceId, std::string serviceDescription)
{
...
void DemoBaseApplLayerRSU::stopService()
{
    cancelEvent(sendWSAEvt);
    currentOfferedServiceId = -1;
}

void DemoBaseApplLayerRSU::sendDown(cMessage* msg)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDown(msg);
}

void DemoBaseApplLayerRSU::sendDelayedDown(cMessage* msg, simtime_t delay)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDelayedDown(msg, delay);
}

void DemoBaseApplLayerRSU::checkAndTrackPacket(cMessage* msg)
{
